...
plt.tight_layout()
plt.show()
fig_3d.savefig('../figs/demo_' + name + "_".join(numerical_attributes) + '_multi_class_1.png')
fig.savefig('../figs/demo_' + name + "_".join(numerical_attributes) + '_multi_class_2.png')
